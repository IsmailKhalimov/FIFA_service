"""
Совместимый слой для рантайм-поиска портретов игроков.

Имя модуля оставлено прежним, чтобы не ломать структуру проекта,
но внутри используется новый пайплайн Sports.ru -> Wikipedia.
"""
